...
public class Main {
	...
	public static void main(String[] args) {
		...
		User user1 = new User(1, "Engin", "Demiroğ", "engin@engin.com","123");
		User user2 = new User(2, "Ahmet Yuşa", "Kuşdil", "ahmet@ahmet.com","1234");
	    ...
	    Instructor instructor = new Instructor(1, 1, "Java", "Ödev 1","Eğitmen 1 ");
